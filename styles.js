...
for (let i = 0; i < hour; i++) {
    if (i < hour) {
        descriptionEl.setAttribute('class', 'description past');
    } else if (i === hour) {
        descriptionEl.setAttribute('class', 'description present');
    } else {
        descriptionEl.setAttribute('class', 'description future')
    }    
};
